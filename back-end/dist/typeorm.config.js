...
exports.runMigrations = exports.initializeAppDataSource = exports.AppDataSource = exports.baseDataSourceConfig = void 0;
...
const checkDatabaseExists = async (dbName) => {
    ...
    `, [dbName]);
        ...
        console.error(`Error checking database existence: ${error instanceof Error ? error.message : error}`);
        return false;
    }
    finally {
